...
import image1 from "@/app/assets/start-img1.png";
import imaage2 from "@/app/assets/start-img 2.png";
import image3 from "@/app/assets/start-img 3.png";
  ...
  return (
    <div className="mt-20 ml-64 px-4">
      ...
      <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-5">
        ...
        <div className="w-full sm:w-1/3 md:w-1/4 lg:w-1/4">
          <Image src={imaage2} alt="img2" className="w-full" />
        </div>
        <div className="w-full sm:w-1/3 md:w-1/4 lg:w-1/4">
