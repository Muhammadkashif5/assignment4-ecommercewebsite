...
import logo1 from "@/app/assets/company-name-logo.png";
import Logo2 from "@/app/assets/cart-account-logo.png";
  ...
  return (
    <nav className="w-full h-full  flex flex-col md:flex-row items-center justify-evenly px-4 py-4 md:py-8">
      <div className=" flex justify-center md:ml-5">
        <Image src={logo1} alt="company-name-logo" />
      </div>
      ...
      <div className="hidden md:flex md:ml-12 mt-4 md:mt-0">
        <Image src={Logo2} alt="cart-account-logo.png" />
      </div>
    </nav>
  );
};
